...
export const ProyectCard = ({img, title, description, technologies, urlGithub, urlDeploy}: ProyectCardProps) => {
    return (
        <article className="h-540 w-full shadow-md rounded bg-white p-4 mt-10">
            ...
            <a href={urlDeploy} id='button' className="flex flex-row gap-1 items-center bg-primary text-disabled-light px-5 py-3 rounded-md cursor-pointer hover:text-white hover:animate-bounce">
                <UrlIcon/> 
                <span>Live</span>
            </a>
            <a href={urlGithub} id='button' className="flex flex-row gap-1 items-center bg-primary text-disabled-light px-5 py-3 rounded-md cursor-pointer hover:text-white hover:animate-bounce">
                <GithubIcon/>
                <span>Source</span>
            </a>
            </div>
