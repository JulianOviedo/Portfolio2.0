    ...
    return (
        <article className="h-540 w-full shadow-md rounded bg-white p-4 mt-10 lg:mt-0 lg:w-[600px]">
            ...
            <div className="flex flex-row gap-2 text-sm lg:justify-center">
                ...
                <a href={urlGithub} target="_blank" id='button' className="flex flex-row gap-1 items-center bg-primary text-disabled-light px-5 lg:px-10 py-3 rounded-md cursor-pointer hover:text-white hover:animate-bounce">
                    <GithubIcon />
                    <span>Source</span>
                </a>
            </div>
